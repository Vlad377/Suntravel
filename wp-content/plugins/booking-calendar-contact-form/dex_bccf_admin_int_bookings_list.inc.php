...
if (wp_verify_nonce( $_REQUEST['_wpnonce'], 'uname_bccf' ) && isset($_GET['ld']) && $_GET['ld'] != '')
{
...
<script type="text/javascript">
 function cp_deleteMessageItem(id)
 {
    ...
    {        
        document.location = 'admin.php?page=dex_bccf.php&cal=<?php echo $_GET["cal"]; ?>&list=1&_wpnonce=<?php echo $nonce_un; ?>&ld='+id+'&r='+Math.random();
    }
 }
</script>
<div class="wrap">
...
echo paginate_links(  array(
    'base'         => 'admin.php?page=dex_bccf.php&cal='.CP_BCCF_CALENDAR_ID.'&list=1%_%&dfrom='.urlencode($_GET["dfrom"]).'&dto='.urlencode($_GET["dto"]).'&search='.urlencode($_GET["search"]),
    'format'       => '&p=%#%',
    'total'        => $total_pages,
