...
<?php } ?>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
    ...
    <table class="form-table">
        ...
        <td><div style="float:left"><input required type="text" name="currency" size="3" value="<?php echo esc_attr(dex_bccf_get_option('currency',DEX_BCCF_DEFAULT_CURRENCY)); ?>" /></div>
        ...
        <td><input required type="text" size="5" name="request_cost" value="<?php echo esc_attr($request_costs[0]); ?>" /></td>
        </tr>
  ...
  <div class="inside">
    ...
    <table class="form-table">
        ...
        <th scope="row">Enable Paypal Payments?</th>
         ...
         <em>* PayPal is required in this free version since the form is processed on the PayPal IPN notification. For other versions without PayPal payments or with optional PayPal payment for the customer please check the <a href="http://bccf.dwbooster.com">plugin's page</a>.</em>
        </td>
        </tr>

        <tr valign="top">
        <th scope="row">Paypal email</th>
        <td><input required type="email" name="paypal_email" size="40" value="<?php echo esc_attr(dex_bccf_get_option('paypal_email',DEX_BCCF_DEFAULT_PAYPAL_EMAIL)); ?>" /></td>
        </tr>
        ...
        <td>
           <em>This feature is available in the <a href="http://bccf.dwbooster.com/download">pro version</a>.</em>          
        </td>
        </tr>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     ...
     <em>* Note: The Form Builder isn't available in this version. For a version with a fully functional Form Builder <a href="http://bccf.dwbooster.com/download">check the pro version</a>.</em>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">   
     <table class="form-table">    
        ...
        - For general CSS styles modifications to the form and samples <a href="http://bccf.dwbooster.com/faq#q82" target="_blank">check this FAQ</a>.
        </tr>
     </table>
  </div>    
 </div> 
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     <table class="form-table">
        ...
        <td><input required type="email" name="notification_from_email" size="40" value="<?php echo esc_attr(dex_bccf_get_option('notification_from_email', DEX_BCCF_DEFAULT_PAYPAL_EMAIL)); ?>" /></td>
        </tr>
        <tr valign="top">
        <th scope="row">Send notification to email</th>
        <td><input required type="text" name="notification_destination_email" size="40" value="<?php echo esc_attr(dex_bccf_get_option('notification_destination_email', DEX_BCCF_DEFAULT_PAYPAL_EMAIL)); ?>" />
            <br />
...
[<a href="https://wordpress.org/support/plugin/booking-calendar-contact-form#new-post" target="_blank">Support</a>] | [<a href="http://bccf.dwbooster.com" target="_blank">Documentation</a>]
</form>
</div>
<script type="text/javascript">
